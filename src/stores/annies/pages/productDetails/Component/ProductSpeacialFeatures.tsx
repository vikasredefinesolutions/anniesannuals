...
const ProductSpecialFeature: React.FC<IProps> = ({
  producFilterFacetFields,
}) => {
  const SpecialFeature = producFilterFacetFields?.filter((el) => {
    if (el.name == 'Features/Category') return el;
  })[0]?.values;
  const cardColors = [
    'bg-primary',
    'bg-[#634B91]',
                          ...
                          {SpecialFeature?.map((el, index) => {
                            ...
                            return (
                              <div
                                ...
                                key={el.value}
                              >
                                <div className='flex items-center gap-[20px] px-[5px] py-[10px] mb-[20px] last:mb-0 '>
                                  {el.iconCode && (
                                    <div
                          ...
                          {SpecialFeature?.map((el, index) => {
                            ...
                            return (
                              <div
                                ...
                                key={el.value + index}
                              >
                                <div className='flex items-center gap-[20px] px-[5px] py-[10px] mb-[20px] last:mb-0 456456456'>
                                  {el.iconCode && (
                                    <div
                                      className={`w-[35px] h-[35px] ${
                                        cardColors[index % cardColors.length]
                            ...
                            // if (index == SpecialFeature.length - 1)
                            //   return (
                            //     <div
                            //       className='col-span-1 border-t border-gray-border first:border-t-0'
                            //       key={el.value + index}
...
export default ProductSpecialFeature;
